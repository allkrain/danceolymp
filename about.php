  ...
  <main class="page">
    ...
    <section class="page-section trainers slider">
      ...
      <div class="trainers-describe container">
        <div class="trainers-describe__item animated" data-target-text="trainer1">
          <p>
        ...
        <div class="trainers-describe__item animated" data-target-text="trainer2">
          <p>
        ...
        <div class="trainers-describe__item animated" data-target-text="trainer3">
          <p>
