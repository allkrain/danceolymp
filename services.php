    ...
    <div class="container">
      <section class="service">
        ...
        <div class="service__content">
          ...
          <div class="service__btns">
            ...
            <a href="dance-styles.php" class="service__btn btn btn_round btn_plus">Стили</a>
            <a href="trainers.php" class="service__btn btn btn_round btn_plus">Преподаватели</a>
          </div>
        </div>
      </section>
      ...
      <section class="service">
        ...
        <ul class="service__btns-list">
          <li><a href="" class="btn btn_round btn_plus">Бальные танцы</a></li>
          <li><a href="" class="btn btn_round btn_plus">Танго-mix</a></li>
          <li><a href="" class="btn btn_round btn_plus">Группа 3</a></li>
          <li><a href="" class="btn btn_round btn_plus">Группа 4</a></li>
          <li><a href="" class="btn btn_round btn_plus">Группа 5</a></li>
          <li><a href="" class="btn btn_round btn_plus">Группа 6</a></li>
          <li><a href="" class="btn btn_round btn_plus">Группа 7</a></li>
          <li><a href="" class="btn btn_round btn_plus">Группа 8</a></li>
          <li><a href="" class="btn btn_round btn_plus">Группа 9</a></li>
          <li><a href="" class="btn btn_round btn_plus">Группа 10</a></li>
        </ul>
      </section>
      ...
      <section class="service">
        <figure class="service__img">
          ...
          <figcaption><span>Свадебный</span> танец</figcaption>
        </figure>
        <div class="service__content">
          <p>
      ...
      <section class="service">
        <figure class="service__img">
          ...
          <figcaption><span>Корпоративные</span> программы</figcaption>
        </figure>
        <div class="service__content">
          <p>
      ...
      <section class="service">
        <figure class="service__img">
          ...
          <figcaption><span>Танцевальный</span> вечер</figcaption>
        </figure>
        <div class="service__content">
          <p>
      ...
      <section class="service">
        <figure class="service__img">
          ...
          <figcaption><span>Подарочный</span> сертификат</figcaption>
        </figure>
        <div class="service__content">
          <p>
            В программу таких вечеров включаются выступления профессиональных танцевальных пар, проведение мастер-классов для гостей,
      ...
      <section class="service">
        <figure class="service__img">
          ...
          <figcaption>Подготовка <span>к соревнованиям</span></figcaption>
        </figure>
        <div class="service__content">
          <p>
            В программу таких вечеров включаются выступления профессиональных танцевальных пар, проведение мастер-классов для гостей,
