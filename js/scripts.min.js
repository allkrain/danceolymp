  ...
  if ( $('.popup-slideshow').length ) {
    (function() {
      ...
      document.querySelector('#popup-next-slide').addEventListener('click', function() {
        popupSlideshow.next();
        $('.trainers-describe__item.active').slideUp().removeClass('active');
        if($('.popup-slideshow .slide--current').is($('.popup-slideshow .ss-slide').last())) {
          $('[data-target-text="' + $('.popup-slideshow .ss-slide').first().data('target-slide') + '"]').slideDown(function () {
            $(this).addClass('active');
          });
        } else {
          $('[data-target-text="' + $('.popup-slideshow .slide--current').next().data('target-slide') + '"]').slideDown(function () {
            $(this).addClass('active');
          });
        }
      });
      ...
      document.querySelector('#popup-prev-slide').addEventListener('click', function() {
        ...
        if($('.popup-slideshow .slide--current').is($('.popup-slideshow .ss-slide').first())) {
          $('[data-target-text="' + $('.popup-slideshow .ss-slide').last().data('target-slide') + '"]').slideDown(function () {
            $(this).addClass('active');
          });
        } else {
          $('[data-target-text="' + $('.popup-slideshow .slide--current').prev().data('target-slide') + '"]').slideDown(function () {
            $(this).addClass('active');
          });
        }
      });
...
$('.slideshow .slider__item').click(function() {
  ...
  $('[data-target-text="' + targetId + '"]').slideDown(function () {
    $(this).addClass('active');
  });
});
