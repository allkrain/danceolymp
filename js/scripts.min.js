...
$(document).ready(function(){
  $('.trainers-carousel__wrapper').slick({
    ...
    slide: 'div',
    speed: 400,
    asNavFor: '.trainers-describe'
  });
  
  $('.trainers-describe').slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    infinite: true,
    dots: false,
    ...
    cssEase: 'linear',
    arrows: false,
    asNavFor: '.trainers-carousel__wrapper',
    slide: 'div',
    adaptiveHeight: true,
    speed: 300
  });
...
$('.trainers-carousel__wrapper').on('beforeChange', function(event, slick, currentSlide, nextSlide) {
  var direction = (function () {
    if((nextSlide === 0 && currentSlide === (slick.$slides.length - 1)) || (nextSlide === (slick.$slides.length - 1) &&  currentSlide === 0)) {
      if(nextSlide === 0 && currentSlide === (slick.$slides.length - 1)) {
        return 'next';
      }
      if((nextSlide === (slick.$slides.length - 1) &&  currentSlide === 0)) {
        return 'prev';
      }
    } else {
      return ((nextSlide - currentSlide) > 0) ? 'next' : 'prev';
    }
  })();
  
  if ( direction === 'next' ) {
    $(slick.$slides[nextSlide].querySelector('.trainers__item')).css({transform : 'translateX(100%) rotateZ(' + anime.random(10, 25) + 'deg)', opacity: 0});
    
    var Aout = anime({
      targets: slick.$slides[currentSlide].querySelectorAll('.trainers__item'),
      translateX : '-100%',
      opacity : 0,
      duration: 1200,
      easing : 'easeOutQuint'
    ...
    var Ain = anime({
      targets: slick.$slides[nextSlide].querySelectorAll('.trainers__item'),
      translateX : '0%',
      rotateZ : 0,
      opacity : 1,
      duration: 700,
    ...
    $(slick.$slides[nextSlide].querySelector('.trainers__item')).css({transform : 'translateX(-100%) rotateZ(' + anime.random(-25, -10) + 'deg)', opacity: 0});
...
$('.slideshow .slider__item').click(function() {
  ...
  $('.trainers-carousel__wrapper .slick-slide').each(function () {
  ...
  $('.trainers-describe').show(function () {
    $(this).addClass('active');
  });
});
...
$('.trainers-carousel__btn').click(function() {
  ...
  $(this).closest('.trainers-carousel').siblings('.slideshow').find('.trainers__controls').show();
  
  $('.trainers-describe.active').hide().removeClass('active');
...
//переход по кнопке записаться в расписаниях

$(document).ready(function() {
  $(".shedule__order-btn").click(function() {
    var elementClick = $(this).data('form-id'); 
    var destination = $('#' + elementClick).offset().top - $('.page-header').outerHeight();
    $("html, body").animate({
      scrollTop: destination
    }, 800, function (){
      $('.support_shedule .order-form__container input:eq(0)').focus();
    });
    return false;
  });
});
