...
$(document).ready(function(){
  ...
  $('.trainers-describe__item').css({'display' : 'block'}).each(function () {
    ...
    trHeight.push($(this).outerHeight());
  });
  
  $('.trainers-describe').css({'position' : '', 'opacity' : '1'});
  $('.trainers-describe__item').css({'display' : 'none'});

  console.log('Ar:' + trHeight + 'max: ' + trDescribeHeight);
  
  $('.trainers-describe__item').css({ 'height' : trDescribeHeight});
});
