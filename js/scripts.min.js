...
$(document).ready(function(){
  ...
  if ( $('.popup-slideshow').length ) {
    (function() {
      ...
      document.querySelector('#popup-next-slide').addEventListener('click', function() {
        popupSlideshow.next();
        $('.trainers-describe__item.active').removeClass('slideDown').addClass('slideUp').removeClass('active');
        if($('.popup-slideshow .slide--current').is($('.popup-slideshow .ss-slide').last())) {
          $('[data-target-text="' + $('.popup-slideshow .ss-slide').first().data('target-slide') + '"]').removeClass('slideUp').addClass('slideDown').addClass('active');
        } else {
          $('[data-target-text="' + $('.popup-slideshow .slide--current').next().data('target-slide') + '"]').removeClass('slideUp').addClass('slideDown').addClass('active');
        }
      });
      ...
      document.querySelector('#popup-prev-slide').addEventListener('click', function() {
        ...
        if($('.popup-slideshow .slide--current').is($('.popup-slideshow .ss-slide').first())) {
          $('[data-target-text="' + $('.popup-slideshow .ss-slide').last().data('target-slide') + '"]').removeClass('slideUp').addClass('slideDown').addClass('active');
        } else {
          $('[data-target-text="' + $('.popup-slideshow .slide--current').prev().data('target-slide') + '"]').removeClass('slideUp').addClass('slideDown').addClass('active');
        }
      });
    })();
  }
  ...
  $('.trainers-describe__item').each(function () {
    trDescribeHeight = trDescribeHeight > $(this).height() ? trDescribeHeight : $(this).height();
  });
...
$('.slideshow .slider__item').click(function() {
  ...
  if(steps > 0) {
    while (steps > 0) {
      $('#popup-next-slide').click();
      steps = steps - 1;
    }
  } else if (steps < 0) {
    while (steps < 0) {
      $('#popup-prev-slide').click();
      steps = steps + 1;
    }
  }
  ...
  $('[data-target-text="' + targetId + '"]').removeClass('slideUp').addClass('slideDown').addClass('active');
});
