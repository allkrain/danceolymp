...
<body> 
  ...
  <div class="page-section page-intro">
    <div class="container">
      <h1>Преподаватели</h1>
      <p>
        <i>Художественный руководитель студии — Садовский Владимир.</i> Все тренеры, преподающие в студии, являются профессиональными танцорами высокого уровня (класс А, S и M) 
  ...
  <section class="page-section">
    <div class="container">
      <div class="page-btns page-btns_horizontal">
      ...
      <adress>
        ...
        <p>
          Адрес студии: Летниковская, 6A, стр.1
        </p>
      </adress>
    </div>
  </section>
